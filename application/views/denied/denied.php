        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item">500</li>
            </ol>
          </div>
          <div class="col-sm-6">
          </div>
    ...
    <section class="content">
      <div class="error-page">
        ...
        <div class="error-content">
          <h2><i class="fas fa-exclamation-triangle text-secondary"></i> Oops! Access Denied.</h2>
          <p>
			We could not find the page you were looking for. In the meantime, 
			you can contact the administrator to be able to access page <b><?php echo $page;?></b>
          </p>
        </div>
        <!-- /.error-content -->
      </div>
