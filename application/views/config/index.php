    ...
    <div class="row mb-3">
      ...
      <div class="col-lg-9">
        ...
        <div class="row float-right">
          ...
          <a href="<?php echo base_url('Config/add'); ?>">

            <button type="button" class="btn btn-default btn-sm">

              <i class="fa fa-add" aria-hidden="true"></i> Add Config
            ...
            <div class="tab-content" id="custom-tabs-one-tabContent">
              <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                <div class="col-lg-12">
                  <div class="row">
                    <div class="col-md-3">
                      <input type="text" class="form-control form-control-sm" id="company_name" name="company_name" placeholder="Company Name">
                    </div>
                    <div class="col-md-2">
                      <button type="submit" class="btn btn-custon-four btn-default btn-sm" id="search-data-by-company-name">
                ...
                <table class="table table-striped projects" id="data">
                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      <th data-field="code_product" data-editable="true" class="code_product">Company Name</th>

                      <th data-field="email" data-editable="true" class="name_product">IP Address</th>

                      <th data-field="email" data-editable="true" class="variant">API Key</th>
                      
                      <th data-field="email" data-editable="true" class="variant">Created Date</th>
...
<script src="<?php echo base_url(); ?>assets/js-data/config/get-index.js" id="date" data-start="<?php echo date('d-m-Y', strtotime($start)); ?>" data-end="<?php echo date('d-m-Y', strtotime($end)); ?>"></script>
