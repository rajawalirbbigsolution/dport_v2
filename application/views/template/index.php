...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="row">
                ...
                <div class="col-2" style="padding: 10px">
                    <a class="badge  navbar-badge nav-link" data-toggle="dropdown" id="bell-notification"  href="#" style="width: 100%; height: 100%">
                        <img src="<?php echo base_url(); ?>assets/image/icon_bell_nonactive.png" alt="AdminLTE Logo"
                        style="height: 35px">
                        <span id="badge-notification"></span>
                    </a>

                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right" style="border: 1px solid; width: 350px">
                    <div id="div_list">
        ...
        <nav class="mt-2" style="border: none !important; padding-bottom: 60px; padding-top: 0 !important;">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            foreach ($menu_list as $menu) {
              ...
              if ($this->uri->segment(1) != "marketplace"){
                  $is_active = $this->uri->segment(1) == $menu->module_link;
              } else {
                  $is_active = $this->uri->segment(1).'/'.$this->uri->segment(2) == $menu->module_link;
              }
              if ($menu->is_parent == '1' && $menu->module_link != '') {
                ...
                if($this->uri->segment(1) == "marketplace"){
                    echo '
                <a href="' . base_url() . $menu->module_link . '" class="nav-link ' . ($this->uri->segment(1).'/'.$this->uri->segment(2) == $menu->module_link ? 'active' : '') . '">
                  <p>' . $module_name . '</p>
                </a>
              </li>';
                } else {
  ...
  <script>
    $(document).ready(function() {
      ...
      // $('a.nav-link.active').closest('li.has-treeview').addClass('pb5');
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            response.forEach(function(row) {
                ...
                $('#div_list').append('<div style="border-bottom: 1px solid #e9ecef;font-size:0.8rem;">location = ' + row.location_name + "<br> Product = " +
