                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                     <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-3">
                                <input type="text" class="form-control form-control-sm" id="dates_status" name="date">
                            </div>
                            <div class="col-md-2">
                                <select class="form-control form-control-sm" name="status" id="status_transactions">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                              <div class="input-group mb-3">
                                ...
                                <!-- <form action="<?php echo site_url('Transaksi/import'); ?>" method="post" id="upload-order" enctype="multipart/form-data"> -->
                                    <!-- <div class="input-group">
                                        <input type="file" class="form-control form-control-sm" placeholder="File belum dipilih" name="data_order" id="fileUpload">  -->
                                        <!-- <span class="input-group-btn active-hook">  -->
                                            <!-- <a href="javascript:document.getElementById('upload-order').submit();"> -->
                                               <!--  <button type="button" class="btn btn-sm btn-default btn-lg" id="btn-upload">
                                                    <i class="fa fa-upload fa-lg" aria-hidden="true"></i>
                                                </button>  -->
                                            <!-- </a> -->
                                        <!-- </span> -->
                    ...
                    <div class="table-responsive">
                      ...
                      <thead>
                        <tr>
                            ...
                            <th data-field="name" data-editable="true" class="id_order">ID Order </th>
                            <th data-field="email" data-editable="true" class="name_user">Name </th>
                            <th data-field="email" data-editable="true" class="name_product">Name Product</th>
                            <th data-field="email" data-editable="true" class="bump">Provinsi</th>
                            <th data-field="email" data-editable="true" class="status">Status</th>
                            <th data-field="email" data-editable="true" class="coupon">Coupon</th>
                            <th data-field="email" data-editable="true" class="payment_status">Payment Status</th>
                            <th data-field="email" data-editable="true" class="handle">Handle</th>
                            <th data-field="email" data-editable="true" class="order_date">Order Date</th>
...
<script src="<?php echo base_url(); ?>assets/js-data/order/js-data.js" id="date" data-start="<?php echo date('d-m-Y', strtotime($start)); ?>" data-end="<?php echo date('d-m-Y', strtotime($end)); ?>"></script>
