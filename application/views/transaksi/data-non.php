...
<script src="<?php echo base_url(); ?>assets/js-data/ordernon/js-data-3.js" id="date" data-start="<?php echo date('d-m-Y', strtotime($start)); ?>" data-end="<?php echo date('d-m-Y', strtotime($end)); ?>"></script>
