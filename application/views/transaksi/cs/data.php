                        ...
                        <div class="row">
							...
							<div class="col-md-4">
								<div class="row float-center">
									...
									<div class="col-md-4 col-6">
										<div class="form-group">
											<button type="submit" class="btn btn-custon-four btn-default btn-sm" id="download-data-by-date">
...
<script src="<?php echo base_url(); ?>assets/js-data/order/cs/js-data.js" id="date" data-start="<?php echo date('d-m-Y', strtotime($start)); ?>" data-end="<?php echo date('d-m-Y', strtotime($end)); ?>"></script>
