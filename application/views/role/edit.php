            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form id="add-product" role="form" action="<?php echo base_url('Role/update') ?>" method="post" enctype="multipart/form-data" class="add-department" autocomplete="off">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                            ...
                                            <div class="input-mark-inner mg-b-22">
                                                ...
                                                <input type="text" class="form-control" name="role_name" placeholder="Nama Role" value="<?php echo $data->role; ?>">
                                                <input type="hidden" name="id" value="<?php echo $data->id; ?>">

                                                <small class="form-text text-muted"><?php echo form_error('role_name');  ?></small>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                                ...
                                                <div class="input-mark-inner mg-b-22">
                                                    ...
                                                    <a href="<?php echo base_url('Role') ?>" class="btn btn-danger" style="margin-left: 5px;">Back</a>
