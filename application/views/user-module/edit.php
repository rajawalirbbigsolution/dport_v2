        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <div class="card-header">
              ...
              <h3 class="card-title">Edit User Module</h3>

            </div>

            <form id="add-product" role="form" action="<?php echo base_url('UserModule/update') ?>" method="post" enctype="multipart/form-data" class="add-department" autocomplete="off">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                      ...
                      <div class="input-mark-inner mg-b-22">
						...
						<select class="form-control" name="role_id" id="role_id_form_edit">
