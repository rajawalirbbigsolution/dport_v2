                      ...
                      <div class="row float-center">
                         ...
                         <div class="col-md-4 col-6">
                          ...
                          <div class="form-group">
                            <a href="<?php echo base_url();?>ReportSelisih/downloadExcel" class="btn btn-custon-four btn-default btn-sm" id="download-manifest">
                  ...
                  <table class="table table-striped projects" id="data">
                    ...
                    <thead>
                      ...
                      <tr>
                        ...
                        <th data-field="code_product" data-editable="true" class="code_product">#</th>
                        <th data-field="phone" data-editable="true" class="berat">SKU</th>
                        <th data-field="phone" data-editable="true" class="berat">ID PRODUCT</th>
                        <th data-field="phone" data-editable="true" class="berat">PRODUCT NAME</th>
                        <th data-field="phone" data-editable="true" class="berat">MINIMUM STOCK</th>
                        <th data-field="phone" data-editable="true" class="berat">QUANTITY</th>
                        <th data-field="phone" data-editable="true" class="berat">OUTLET STOCK</th>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="modal-body">
            <p>Kirim Ulang <b class="message"></b></p>
            <br>
          </div>
...
<script src="<?php echo base_url(); ?>assets/js/jquery-ui.js" type="text/javascript"></script>
 ...
 <script src="<?php echo base_url(); ?>assets/js-data/notif/get-index.js" id="date" data-start="<?php echo date('d-m-Y', strtotime($start)); ?>" data-end="<?php echo date('d-m-Y', strtotime($end)); ?>"></script> 
