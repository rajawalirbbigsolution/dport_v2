    ...
    <table class="table projects" name="myTable" id="data" style="border-top: none">
        ...
        <thead>
            ...
            <tr>
                ...
                <th data-field="module_name" data-editable="true" class="module_name">MINIMUM STOCK</th>
...
<script src="<?php echo base_url(); ?>assets/js-data/notif/get-min.js" id="date"></script>    