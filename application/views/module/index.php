              ...
              <div class="table-responsive">
                  ...
                  <div class="container-fluid">
                      <div class="row p-3">
                          ...
                          <div class="col-md-2">
                              <a href="<?php echo base_url('Module/add') ?>" type="button" class="btn btn-primary btn-dws-add btn-block">
                ...
                <table class="table table-striped projects" id="data">
                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      <th data-field="module_name" data-editable="true" class="module_name">Nama Modul</th>

                      <th data-field="module_url" data-editable="true" class="name_product">Url Modul</th>
